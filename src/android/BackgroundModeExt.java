...
public class BackgroundModeExt extends CordovaPlugin {
                            ...
                            CallbackContext callback)
    {
        ...
        Log.d("BackgroundModeExt", "Execute: " + action + " with: " + args.toString());
        switch (action)
        {
            case "battery":
        ...
        if (validAction) {
            ...
            Log.d("BackgroundModeExt", "Execute: " + action + " Invalid");
        }
    ...
    private void moveToBackground()
    {
        ...
        Log.d("BackgroundModeExt", "moveToBackground");
    }
    ...
    private void moveToForeground()
    {
        ...
        Log.d("BackgroundModeExt", "moveToForeground");
    }
    ...
    {
        Log.d("BackgroundModeExt", "addSreenAndKeyguardFlags");
    ...
    {
        Log.d("BackgroundModeExt", "clearScreenAndKeyguardFlags");
